    ...
    <motion.div
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          ...
          <div style={{ width: 1, height: 20, background: borderColor, opacity: 0.5 }} />
          <span style={{
...
<main style={{ maxWidth: '72rem', margin: '0 auto', padding: '2.5rem 1.5rem' }}>
        ...
        <section style={{ marginBottom: '3rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.5rem' }}>
            ...
            <div style={{ flex: 1, height: 1, background: borderColor, opacity: 0.4 }} />
          </div>
          <TypewriterHero blueprintMode={false} />
        </section>

        <hr style={{ borderTop: `1px solid ${borderColor}`, opacity: 0.4, marginBottom: '2.5rem' }} />
        ...
        <section style={{ marginBottom: '1.5rem' }}>
          <label style={{
            ...
            display: 'block',
            marginBottom: '0.5rem',
          }}>Your Technical Requirement</label>
          <div style={{
            ...
            <textarea
              rows={3}
              placeholder="Describe your technical requirement or business objective..."
              value={userInput}
